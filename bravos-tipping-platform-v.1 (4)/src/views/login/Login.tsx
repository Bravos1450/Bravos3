...
const Login: React.FC = () => {
    ...
    const handleFirebaseLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const userDocSnap = await db.collection('users').doc(userCredential.user.uid).get();
    ...
    const inputStyles = "appearance-none block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm";
